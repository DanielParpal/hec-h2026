...
À votre tour de pratiquer l'utilisation de données et variables en PHP!
...
$quantite = 4;
echo "La quantité initiale est: $quantite <br>";
$quantite = $quantite - 2;
...
echo "<br>";
$tailles[] = "XL";
echo "La nouvelle quantité d'éléments dans mon tableau est: " . count($tailles);
echo "<br>";
var_dump($tailles);
